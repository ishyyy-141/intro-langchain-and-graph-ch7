...
async def async_main():
    ...
    rag.load_documents(documents=sample_docs)
    query = "Who introduced the theory of relativity?"
    relevant_doc = rag.get_most_relevant_docs(query=query)

    answer = rag.generate_answer(query=query, relevant_doc=relevant_doc)
